...
public class SignInActivity extends AccountAuthenticatorActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        startService(new Intent(this, AuthentificatorService.class));
    ...
    public void submit() {
        ...
        final String accountType = "com.auth"; //getIntent().getStringExtra(ARG_ACCOUNT_TYPE);
        ...
        new AsyncTask<String, Void, Intent>() {
            ...
            protected Intent doInBackground(String... params) {
                ...
                try {
                    ...
                    if(AccountGeneral.
                            sServerAuthenticate.userSignInWithoutToken(userName, userPass, mAuthTokenType))
                    {
    ...
    private void finishLogin(Intent intent) {
        ...
        String test = intent.getStringExtra(AccountManager.KEY_ACCOUNT_TYPE);
